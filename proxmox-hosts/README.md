...
| [proxmox_vm_options.yml](docs/proxmox_vm_options.md) | 既存VMの動作設定(QEMUエージェント/自動起動/説明等)を変更する |
| [proxmox_vm_cloudinit.yml](docs/proxmox_vm_cloudinit.md) | 既存VMのcloud-init設定(ユーザー/パスワード/SSH公開鍵/IP)を変更する |
